 ...
 * DeepSeek оценивает вероятность нахождения товара на странице по 10-балльной шкале
 * (priority от 1 до 10, где 10 — максимальная вероятность), и возвращает JSON с execution_status=1.
 *
...
Твоя задача — оценить вероятность нахождения указанного товара на каждой из этих страниц по 10-балльной шкале.

Правила:
- Оцени каждую ссылку по шкале от 1 до 10, где 10 — максимальная вероятность того, что на этой странице продаётся или перечисляется данный товар или его категория.
- Если страница явно не относится к товару (сервисы, калькуляторы, аутсорсинг, контакты, новости и т.п.), установи priority = 1.
- Если страница точно содержит данный товар или его прямую категорию, установи priority = 10.
- Промежуточные значения (2-9) выставляй в зависимости от степени вероятности нахождения товара.
...
[{"id": число, "html": "строка", "execution_status": 1, "priority": число от 1 до 10}]
PROMPT;
